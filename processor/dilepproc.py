...
class exampleProcessor(processor.ProcessorABC):
    ...
    def process(self, df):
        ...
        fw_pt_total_data = ((fw.pt.sum()) + df["MET"].sum())                
        ...
        output['fw_pt_total'].fill(dataset=dataset, pt=fw_pt_total_data[event_selection].counts, weight=df['weight'][event_selection]*cfg['lumi'])
...
def main():
    ...
    # histograms
    histograms = []
    histograms += ['N_ele', 'N_mu', 'N_diele', 'N_dimu', 'MET_pt', 'pt_spec_max', 'MT', 'HT', 'ST', 'mbj_max', 'mjj_max', 'mlb_max', 'mlb_min', 'mlj_max', 'mlj_min', 'N_b', 'N_jet', 'N_spec', 'fw_pt_total']
